...
<div class="m-auto w80 my-4">
    ...
    <form action="user&action=save" method='post' enctype="multipart/form-data">
        ...
        <div class="my-2">
            ...
            <input required class="form-control w30" type="text" id='username' name="username" value="<?= $username ?>" <?= $disabled ?>>
        </div>
        <div class="my-2">
        ...
        <div class="my-2">
            ...
            <input class="form-control w70" type="password" id='password' name="password" placeholder="Ne rien saisir pour garder l'ancienne valeur" value="" <?= $disabled ?>>
        </div>
